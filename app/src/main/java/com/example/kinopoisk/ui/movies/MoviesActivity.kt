package com.example.kinopoisk.ui.movies
...
import com.example.kinopoisk.ui.poster.PosterActivity
...
class MoviesActivity : Activity(),MoviesView {
    ...
    private val moviesSearchPresenter = Creator.provideMoviesSearchPresenter(this, context = this)
